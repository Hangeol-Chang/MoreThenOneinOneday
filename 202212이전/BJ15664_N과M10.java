...
//해쉬맵
	public static void main(String[] args) throws IOException {
		...
		powerset(0, map, new StringBuilder(), 0);
		
		System.out.println(sb);
	}
	public static void powerset(int count, TreeMap<Integer, Integer> map, StringBuilder merge, int vaal) {
		if(count == M) {
			sb.append(merge + "\n");
			return;
		}
...
//		System.out.println(count + " " + map);
		for(int key : map.keySet()) {
			...
			powerset(count+1, newmap, newmerge, key);
		}
	}
}
